...
The vSphere controller manager update can be executed before upgrading the cluster version to v1.22.13. 
The current version is compatible with Kubernetes 1.22.x and its standard skew versions.
